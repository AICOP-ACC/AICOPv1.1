              ...
              <div class="menu_section">
				...
				<ul class="nav side-menu" id="sidemenu">
 					<li id="home"  ><a ><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    	 ...
                    	 <li><a href="executiveView.do">Executive View</a></li> 
	                      <li><a href="detailedView.do">Business View</a></li>
	                        
                    </ul> 
                  </li>
   <li><a id="Business_Process"><i class="fa fa-sitemap"></i> Business Process <span class="fa fa-chevron-down"></span></a>
     <ul class="nav child_menu">
     
                        <li><a>Porting Management<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
			                        ...
			                        <li><a>Port In<span class="fa fa-chevron-down"></span></a>
			                          <ul class="nav child_menu">
			                            <li class="sub_menu"><a href="">Business Process Flow</a></li>
